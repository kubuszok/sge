/** The PORT half of jbump's differential probe. Its twin is `ProbeJava.java` beside it, and `just jbump-measure` runs both and diffs the transcripts line for line.
  */
object Probe {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(
      "MathUtils nextPowerOfTwo(100)=" + MathUtils.nextPowerOfTwo(100) + " clamp=" + MathUtils.clamp(9, 0, 5) +
    ...
    println(
      "MathUtils random(10)=" + MathUtils.random(10) + "," + MathUtils.random(10) + " sign=" + Extra.sign(-3f) +
    ...
    println(
      "Rect containsPoint=" + Rect.rect_containsPoint(0f, 0f, 2f, 2f, 1f, 1f) +
