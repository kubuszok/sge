 ...
 *   This file is the INJECTED replacement for the upstream Align class, dropped by
 *   Substitutions.dropTypes and re-pointed by PrimitiveToOpaqueTransform(Existing).
