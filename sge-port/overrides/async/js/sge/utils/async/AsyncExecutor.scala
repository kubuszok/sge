 ...
 * Covenant-baseline-methods: AsyncExecutor,close,result,submit,this
 * Covenant-source-reference: backends/gdx-backends-gwt/src/com/badlogic/gdx/backends/gwt/emu/com/badlogic/gdx/utils/async/AsyncExecutor.java
