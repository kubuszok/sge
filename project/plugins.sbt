...
libraryDependencies += "com.kubuszok" %% "balticporter-corpus" % "04a302c5f73b26be6a2ba6a6bef645e1dec54b31-SNAPSHOT"
// Non-Java frontend: RAST readers, ParityDerive, body translators (Phase 3 proof)
libraryDependencies += "com.kubuszok" %% "balticporter-frontend-ts" % "04a302c5f73b26be6a2ba6a6bef645e1dec54b31-SNAPSHOT"
