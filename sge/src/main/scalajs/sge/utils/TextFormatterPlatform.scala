/*
 * Scala.js TextFormatter platform — no java.text.MessageFormat on this platform.
 */
package sge
package utils
...
private[utils] object TextFormatterPlatform {
  ...
  /** Scala.js ships no `java.text.MessageFormat`: none, so `TextFormatter` always formats simply, as libGDX's GWT emulation of it does whatever `useMessageFormat` says.
    */
